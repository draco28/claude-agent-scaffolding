...
- **#82 — anti-rot seam-lint.** `tests/test-review-gate.sh` gains `test_seam_premerge_gate_contract`, pinning the new gate clauses against `git-workflow.md` so the (unenforced-by-design) reasoning contract can't silently rot. 9 new assertions.
