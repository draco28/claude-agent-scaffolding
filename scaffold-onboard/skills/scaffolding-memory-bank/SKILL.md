...
Dispatch the 9 artifacts in Wave 4. All artifacts are independent of each other (no sequential ID-dependency within this skill), so they can be dispatched in parallel. Maintain a running ledger from the start:
