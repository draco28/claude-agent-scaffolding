#!/usr/bin/env node
// Fake codex-companion for scaffold-onboard tests (SS-5.1). Emits env-driven
...
switch (sub) {
  ...
  case "result": {
    // SS-5.1: the default return is SYNTHESIS-shaped ({mode, output_path,
    // ids_minted, ids_cited, summary}), not the implementer shape.
    const raw =
