...
12 surfaces, 55 fixtures × 2 dispatches = 110 Agent dispatches per full run; 5-10 min. Re-run a single surface by deleting its `results/<surface>/*.json` and re-running.
