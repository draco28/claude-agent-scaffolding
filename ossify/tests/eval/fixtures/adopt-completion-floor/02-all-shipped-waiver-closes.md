...
that walk named. The record carries its per-station lines (`feature_add: 0
waived`, `bone_add: 3`, `posture_set: fully-private`, critic `skip`,
smoke 4 verified / 0 unverified), and `oss doctor` is green.
