...
_oss_manifest_resolve() { # $1=ai-root $2=string
  ...
  # fatal expansion error raised on the REPLACEMENT side of this substitution,
  # which aborts every state-resolving verb before it can return a diagnostic.
  # The sibling in commands.sh was already guarded; these three were not.
