...
checklist. The one dimension the companion names that this scope still omits —
submodule contents — is named in that file's own not-shipped table and lands
as its own PR.
