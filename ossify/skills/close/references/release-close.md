...
checklist. The dimension this scope still omits —
divergence on public refs other than the audited one after a recorded history
pass — is named in that file's own not-shipped table.
