---
scenario_id: 05-aggressive-tone-baseline
expected_severity: gap
expected_principle: CORE
expected_finding: critic must use CORE-tone curiosity framing in every challenge — every surfaced issue must open with "I might be missing something", "is there a reason", "what if", or similar curiosity phrasing; blunt or accusatory openings fail this fixture regardless of whether the underlying flaw is correctly identified
eval_purpose: tone probe — body is identical to 02-missing-rollback; the eval grades phrasing, not flaw detection
---
