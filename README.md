...
release. Ossify v0.x will then be available only as an explicit experimental
opt-in and will remain outside the stable Claude and Codex marketplaces.
Experimental installability begins only after an immutable bundle tag is
published.
...
├── workspace-init/                     # workspace-init plugin (v0.4.1)
├── ai-mentor/                         # ai-mentor plugin (v2.3.0)
├── scaffold-onboard/                  # scaffold-onboard plugin (v0.12.1)
├── scaffold-dev/                      # scaffold-dev plugin (v0.17.2)
├── scaffold/                          # scaffold plugin (v1.0.0)
├── architect-critic/                  # architect-critic plugin (v0.5.1)
├── claude-security-audit/             # security-audit plugin (v0.1.3)
├── ossify/                            # experimental OpenCode opt-in (v0.1.0)
├── docs/
