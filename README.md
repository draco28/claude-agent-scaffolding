...
├── ossify/                            # skeleton-first replacement lifecycle (v1.6.0)
├── code-judo/                         # code-judo plugin (v0.1.0)
├── orca-crew/                         # orca-crew plugin (v0.1.0)
├── docs/
