...
The user invoked `/grill-me`. Grill the user on the topic below using the `ai-mentor:grill-me` skill — one question at a time, walk the tree until shared understanding.
